...
export const dashboardSidebarNav: SidebarItem[] = [
  ...
  { title: "Financial Intelligence", href: "/dashboard/financial-intelligence", icon: TrendingUp, badge: "NEW" },
  { title: "Document Verification", href: "/dashboard/pdf-verification", icon: Shield },
  { title: "Master Entity Panel", href: "/dashboard/entities", icon: Building2 },
